Arglist1 <- sqldf(" SELECT * FROM Argumentlistenbackup300621 WHERE Pos IN('Funktion_1') ")
...
Arglist1$Prog <- '~/Tabellenkalkultionsumwandler/Verkettungsschleife.R'
Num$Prog <- c(Arglist1$Prog,'~/Tabellenkalkultionsumwandler/Schleifenumwandlungsres.R')
Progseczahl <- 1
